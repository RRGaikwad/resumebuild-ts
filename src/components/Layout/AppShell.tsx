...
import { FiLayout, FiUser, FiBriefcase, FiBookOpen, FiAward, FiMessageSquare, FiCommand, FiCheckSquare, FiSearch, FiBell, FiGift } from "react-icons/fi";
    ...
    <div className="flex h-screen overflow-hidden bg-[#F8FAFC]">
      ...
      <aside className="hidden md:flex flex-col w-[260px] bg-[#0F172A] z-20 shrink-0">
        ...
        <div className="p-4 mt-auto">
          ...
          <div className="flex items-center gap-3 px-2 py-2 cursor-pointer hover:bg-white/5 rounded-[16px] transition-colors">
            ...
            <div className="flex-1 min-w-0">
              <p className="text-[15px] font-medium text-white truncate">Rohan Gaikwad</p>
      ...
      <div className="flex-1 flex flex-col relative overflow-hidden">
        ...
        <header className="h-[72px] bg-white border-b border-[#E5E7EB] flex items-center px-4 md:px-8 z-10 shrink-0">
          ...
          <div className="flex items-center gap-5 ml-auto">
            ...
            <div className="w-10 h-10 rounded-full overflow-hidden border-2 border-[#E5E7EB] ml-2">
              <img src="https://i.pravatar.cc/100?img=11" alt="User" className="w-full h-full object-cover" />
            </div>
          </div>
        </header>
